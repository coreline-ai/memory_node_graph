...
> **역사 기록 / 전환 예정:** 이 문서의 로컬 Connector는 당시 실제 구현이다. 현재 정본 [현재 OAuth 런타임 방향](../docs/current-oauth-runtime.md)과 [implement_20260807_203534.md](./implement_20260807_203534.md)는 같은 공식 Codex SDK·OAuth·검증 계약을 웹앱 통합 런타임으로 이전하고 `NO SIGNAL`·수동 Connector 실행을 제거한다.
