...
| 항목 | 현재 상태 |
|---|---|
| Git | `main`의 정적 배포·문서 기준 commit `3213aa5`까지 GitHub push 완료. |
...
| GitHub CI | `3213aa5` 대상 `Public Atlas static checks` 성공: <https://github.com/coreline-ai/memory_node_graph/actions/runs/31395725350> |
