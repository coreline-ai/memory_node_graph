...
- 기본 viewport: `825 × 905`
- 데이터: 853문서 · 89,669 고유 엔티티 · 94,488 저장 관계
- corpus 화면: 500노드 · 1,539 실제 관계 · 461 비저장 화면 연결
...
- 데이터 수량, 발광 프리셋, 하단 제어판, dashboard section 구조가 바뀌면 해당 화면만 재촬영한다.
